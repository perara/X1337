...
void init_constants(py::module &m) {
    ...
    auto menu = constants.def_submodule("Menu");
    py::enum_<Constants::MenuC::Options>(constants, "Options", py::arithmetic(), "Menu Option Constants")
            .value("NEW_GAME", Constants::MenuC::Options::NEW_GAME);
